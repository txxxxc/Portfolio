...
type usersttworkspacePortfoliosrcpages404Tsx3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type usersttworkspacePortfoliosrcpages404Tsx3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type usersttworkspacePortfoliosrcpagesindexTsx3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type usersttworkspacePortfoliosrcpagesindexTsx3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
